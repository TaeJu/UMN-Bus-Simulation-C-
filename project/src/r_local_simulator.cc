...
bool rLocalSimulator::Start() {
  ...
  /*Stop ** CC_EB_stops = new Stop *[5]; // 8
  Stop ** CC_WB_stops = new Stop *[6]; // 9
  std::list<Stop *> CC_EB_stops_list;
  std::list<Stop *> CC_WB_stops_list;*/
  Stop ** CC_DN_stops = new Stop *[8];
  Stop ** CC_SV_stops = new Stop *[8];
  std::list<Stop *> CC_DN_stops_list;
  ...
  // CC Dinnaken Stops
  Stop * stop_CC_DN_1 = new Stop(0, 44.973508, -93.224733);
  Stop * stop_CC_DN_2 = new Stop(0, 44.973653, -93.223150);
  Stop * stop_CC_DN_3 = new Stop(0, 44.972457, -93.222493);
  Stop * stop_CC_DN_4 = new Stop(0, 44.973977, -93.219510);
  Stop * stop_CC_DN_5 = new Stop(0, 44.973244, -93.217619);
  Stop * stop_CC_DN_6 = new Stop(0, 44.978417, -93.232012);
  Stop * stop_CC_DN_7 = new Stop(0, 44.973587, -93.229974);
  Stop * stop_CC_DN_8 = new Stop(0, 44.973595, -93.227772);

  // CC SevenHundred Stops
  Stop * stop_CC_SV_1 = new Stop(0, 44.973595, -93.227772);
  Stop * stop_CC_SV_2 = new Stop(0, 44.973587, -93.229974);
  Stop * stop_CC_SV_3 = new Stop(0, 44.978417, -93.232012);
  Stop * stop_CC_SV_4 = new Stop(0, 44.979841, -93.234248);
  Stop * stop_CC_SV_5 = new Stop(0, 44.980804, -93.236665);
  Stop * stop_CC_SV_6 = new Stop(0, 44.980804, -93.236665);
  Stop * stop_CC_SV_7 = new Stop(0, 44.973653, -93.223150);
  Stop * stop_CC_SV_8 = new Stop(0, 44.973508, -93.224733);

  CC_DN_stops_list.push_back(stop_CC_DN_1);
  CC_DN_stops[0] = stop_CC_DN_1;
  CC_DN_stops_list.push_back(stop_CC_DN_2);
  CC_DN_stops[1] = stop_CC_DN_2;
  CC_DN_stops_list.push_back(stop_CC_DN_3);
  CC_DN_stops[2] = stop_CC_DN_3;
  CC_DN_stops_list.push_back(stop_CC_DN_4);
  CC_DN_stops[3] = stop_CC_DN_4;
  CC_DN_stops_list.push_back(stop_CC_DN_5);
  CC_DN_stops[4] = stop_CC_DN_5;
  CC_DN_stops_list.push_back(stop_CC_DN_6);
  CC_DN_stops[5] = stop_CC_DN_6;
  CC_DN_stops_list.push_back(stop_CC_DN_7);
  CC_DN_stops[6] = stop_CC_DN_7;
  CC_DN_stops_list.push_back(stop_CC_DN_8);
  CC_DN_stops[7] = stop_CC_DN_8;
  ...
  CC_SV_stops_list.push_back(stop_CC_SV_6);
  CC_SV_stops[5] = stop_CC_SV_6;
  CC_SV_stops_list.push_back(stop_CC_SV_7);
  CC_SV_stops[6] = stop_CC_SV_7;
  CC_SV_stops_list.push_back(stop_CC_SV_8);
  CC_SV_stops[7] = stop_CC_SV_8;

  double * CC_DN_distances = new double[7];
  double * CC_SV_distances = new double[7];
  CC_DN_distances[0] = 1;
  CC_DN_distances[1] = 2;
  CC_DN_distances[2] = 1;
  CC_DN_distances[3] = 4;
  ...
  std::list<double> CC_DN_probs;
  CC_DN_probs.push_back(.3);
  CC_DN_probs.push_back(.35);
  CC_DN_probs.push_back(.1);
  CC_DN_probs.push_back(.05);
  CC_DN_probs.push_back(.1);
  CC_DN_probs.push_back(.1);
  CC_DN_probs.push_back(.3);
  CC_DN_probs.push_back(0);

  std::list<double> CC_SV_probs;
  CC_SV_probs.push_back(.05);
  CC_SV_probs.push_back(.25);
  CC_SV_probs.push_back(.1);
  CC_SV_probs.push_back(.05);
  CC_SV_probs.push_back(.05);
  CC_SV_probs.push_back(.01);
  CC_SV_probs.push_back(.03);
  CC_SV_probs.push_back(0);

  RtestPassengerGenerator * CC_DN_generator =
  new RtestPassengerGenerator (CC_DN_probs, CC_DN_stops_list);
  RtestPassengerGenerator * CC_SV_generator =
  new RtestPassengerGenerator (CC_SV_probs, CC_SV_stops_list);

  Route * CC_DN = new Route("Campus Apartments Connector - Dinnaken",
   CC_DN_stops, CC_DN_distances, 8, CC_DN_generator);
  Route * CC_SV = new Route("Campus Apartments Connector - SevenHundred",
   CC_SV_stops, CC_SV_distances, 8, CC_SV_generator);

  prototype_routes_.push_back(CC_DN);
