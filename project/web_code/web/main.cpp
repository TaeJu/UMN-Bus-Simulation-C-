...
int BusFactory::stratNum1 = 0;
int BusFactory::stratNum2 = 0;
int BusFactory::stratNum3 = 0;
// FileWriter* FileWriteManager::file_writer = 0;
...
state.commands["listenS"] = new AddStopListenerCommand(mySim);
